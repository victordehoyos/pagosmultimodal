...
public interface RecaudoApi {
    ...
    @ApiOperation(value = "Create Card", nickname = "createCard", notes = "Create Card", response = CreateCardResponse.class, authorizations = {
        @Authorization(value = "basicAuth")
    }, tags={ "recaudo", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful Operation", response = CreateCardResponse.class),
    ...
    ResponseEntity<CreateCardResponse> createCard();
